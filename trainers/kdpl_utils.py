...
def load_teacher_to_cpu(cfg):
    ...
    if teacher_backbone == "ViT-H-14-quickgelu":
        teacher, _, _ = open_clip.create_model_and_transforms(teacher_backbone,  cache_dir="/work/zhangzherui/.cache/huggingface/hub/models--apple--DFN5B-CLIP-ViT-H-14")
        # teacher, _, _ = open_clip.create_model_and_transforms(teacher_backbone, pretrained="/media/data/zhangzherui/code/KDPL/pretrained/open_clip_pytorch_model.bin")
    else:
